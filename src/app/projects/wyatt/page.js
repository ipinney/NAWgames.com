...
export default function WyattProjectsPage() {
  return (
    <div className="min-h-screen">
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-naw-orange/20 via-transparent to-transparent" />
        <div className="relative max-w-4xl mx-auto px-4 pt-12 pb-8">
          ...
          <div className="text-center mt-4">
            ...
            <h1 className="font-game text-2xl sm:text-3xl glow mb-2">
              <span className="bg-gradient-to-r from-naw-orange to-amber-400 bg-clip-text text-transparent">
                WYATT&apos;S PROJECTS
              </span>
            </h1>

...
const PHASES = [
  ...
  { title: '3D print design', when: 'Started Sep 16', status: 'now', text: 'The whole turret is designed (Sep 16): base, turntable with tilt yoke, pivot pin, and the camera and laser head, all fit-checked through the full pan and tilt range. Next: wand handle, and the sensor pod for the stuffed mosquito. Rechecked with real measurements when the parts arrive.', link: CAD },

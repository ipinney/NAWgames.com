...
const PHASES = [
  ...
  { title: '3D print design', when: 'Started Sep 16', status: 'now', text: 'The whole turret is designed (Sep 16): base, turntable with tilt yoke, pivot pin, and the camera and laser head, all fit-checked through the full pan and tilt range. The wand handle and the mosquito sensor pod (a white cup that glows when the laser hits it) are done too. Next: the pendulum guide for the speed test, cable clips, and print plates. Rechecked with real measurements when the parts arrive.', link: CAD },

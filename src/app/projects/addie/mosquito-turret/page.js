...
const PHASES = [
  ...
  { title: '3D print design', when: 'Started Sep 16', status: 'now', text: 'Bought parts modeled; base, turntable with tilt yoke, and pivot pin designed (Sep 16). Next, one at a time: camera and laser head, wand handle, and the sensor pod for the stuffed mosquito. Rechecked with real measurements when the parts arrive.', link: CAD },

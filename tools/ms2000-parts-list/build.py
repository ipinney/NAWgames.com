...
LOCAL=[
 ...
 ('Black foam board (20x30 in) and 1/4" dowels','2 boards, 4 dowels','Craft store'),
 ('Pipe cleaners, wing film or vellum, googly eyes','1 each','Craft store'),
 ('White and colored PLA','About 250 g','On hand'),

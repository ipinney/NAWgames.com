...
PARTS = [
    ...
    ('P2', 'Pan turntable', 'next', [], 'Rides on the pan servo horn, carries the tilt yoke.'),
    ('P3', 'Tilt yoke', 'next', [], 'Holds the tilt servo.'),
    ('P4', 'Camera and laser head', 'next', [], 'HuskyLens on top, laser under it aimed the same way, printed tilt stop, plastic-only laser clamp.'),

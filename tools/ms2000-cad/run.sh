...
mkdir -p $PUB/stl
cp $OUT/ms2000-components.html $OUT/ms2000-turret.html $OUT/ms2000-3d.html $OUT/ms2000-dims.json $PUB/
...
[ -x /opt/batchzero/venv/bin/python ] && /opt/batchzero/venv/bin/python make_hero.py $PUB/ms2000-3d.html ../../public/projects/addie/ms2000-hero.png || echo 'skip hero (needs playwright)'

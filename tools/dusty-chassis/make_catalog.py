...
G = [
 ...
 ('motobit','moto:bit carrier','bought',1,'SparkFun','Motor driver. Clips onto the deck.',['moto:bit']),
 ('microbit','micro:bit v2','bought',1,'Adafruit','Stands in the moto:bit edge connector. LED face points forward.',['micro:bit']),

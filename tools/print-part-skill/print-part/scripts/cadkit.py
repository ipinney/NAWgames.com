...
TEMPLATE = os.path.join(HERE, '..', 'assets', 'viewer.tpl.html')
...
def prism_xz(pts, y0, y1):
    ...
    s = M.extrude(CS([pts]), y1 - y0)          # local (a=x, b=z, c=y)
